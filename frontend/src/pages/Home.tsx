...
const services = [
  ...
  { title: 'Cybersecurity & ATO', slug: 'cybersecurity-compliance', icon: 'Shield', desc: 'Comprehensive security services including ATO support and compliance frameworks.', techs: ['FedRAMP', 'NIST', 'SOC 2'], img: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=600&q=80' },
