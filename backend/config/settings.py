...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'eminence_db'),
        'USER': os.environ.get('POSTGRES_USER', 'eminence_user'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'eminence_dev_password_2024'),
